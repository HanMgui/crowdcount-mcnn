...
if __name__ == '__main__':
    ...
    train_gt = '../data/original/shanghaitech/part_A_final/train_data/ground_truth/'
    out_path = '../data/original/shanghaitech/part_A_final/train_data/true_crowd_counting/'
    validation_num = 15
    ...
    for i in num_list:
        ...
        d_map_h = math.floor(math.floor(float(img.shape[0]) / 2.0) / 2.0)   #1/4
        d_map_w = math.floor(math.floor(float(img.shape[1]) / 2.0) / 2.0)   #1/4
        # starttime = datetime.datetime.now()
        ...
        for j in range(1, 4):
            ...
            for k in range(1, 4):
                ...
                gt_final_name = out_path + mode + '_gt/' + 'IMG_' + str(i) + '_' + str(count)
